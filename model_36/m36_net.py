...
global_model_description = "conv(2/3/4/5/6/7x32)[l2(0.01)] -> relu -> maxpool(2) -> dropout(0.5) -> dense(24) -> dropout(0.5) -> batchnorm -> lstm(150) -> merge(concat) -> dense(1)  [32 batch size]"
...
def build_model(top_words, embedding_vecor_length, max_review_length, show_summaries=False):
	...
	branch_2.add(Dense(24, activation='relu'))
	branch_2.add(Dropout(0.5))
	...
	branch_4.add(Dense(24, activation='relu'))
	branch_4.add(Dropout(0.5))
	...
	branch_5.add(Dense(24, activation='relu'))
	branch_5.add(Dropout(0.5))
	...
	branch_6.add(Dense(24, activation='relu'))
	branch_6.add(Dropout(0.5))
	...
	branch_7.add(Dense(24, activation='relu'))
	branch_7.add(Dropout(0.5))
